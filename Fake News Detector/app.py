# ---------------- NLTK / TextBlob setup fix for Streamlit Cloud ----------------
import os
import nltk
import zipfile
...
# Fix WordNet zip issue: force extraction
...
if os.path.exists(wordnet_zip) and not os.path.exists(wordnet_dir):
    with zipfile.ZipFile(wordnet_zip, "r") as z:
        z.extractall(wordnet_dir)
...
# Download required NLTK datasets (WordNet, Punkt, etc.)
