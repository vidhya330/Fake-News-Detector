...
# ⿡ Set NLTK_DATA to a writable folder (Streamlit Cloud / hosted env)
...
nltk_packages = ["wordnet", "omw-1.4", "stopwords", "punkt", "averaged_perceptron_tagger"]
